...
export const CoApplicantScalarFieldEnum = {
  ...
  firstName: 'firstName',
  lastName: 'lastName',
  aadhaarProvider: 'aadhaarProvider',
...
export const LoanTypeScalarFieldEnum = {
  ...
  defaultLoginCharges: 'defaultLoginCharges',
