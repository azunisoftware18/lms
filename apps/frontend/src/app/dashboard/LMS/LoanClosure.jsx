...
const LoanClosure = () => {
  ...
  const [closureReference] = useState('CLR' + Math.floor(Math.random() * 1000000));
  const [closureDate] = useState(new Date().toLocaleDateString('en-IN', {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric'
  }));
  ...
  return (
    <div className="bg-slate-50 min-h-screen p-4 md:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-600 mt-1">Search, verify, and close loans with NOC generation</p>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-slate-800">Payment Verification</h2>
                </div>
                
                <div className="space-y-4">
                  <div className="flex justify-between py-3 border-b border-slate-100">
                    <span className="text-slate-600">Total Loan Amount</span>
                    <span className="font-medium text-slate-800">₹{searchedLoan.loanAmount}</span>
                  </div>
                  <div className="flex justify-between py-3 border-b border-slate-100">
                    <span className="text-slate-600">Total EMI Paid</span>
                    <span className="font-medium text-green-600">₹{searchedLoan.totalEmiPaid}</span>
                  </div>
                  <div className="flex justify-between py-3 border-b border-slate-100">
                    <span className="text-slate-600">Remaining Balance</span>
                    <span className="font-medium text-slate-800">₹{searchedLoan.outstandingBalance}</span>
                  </div>
                  <div className="flex justify-between py-3 border-b border-slate-100">
                    <span className="text-slate-600">Late Charges</span>
                    <span className="font-medium text-orange-600">₹{searchedLoan.lateCharges}</span>
                  </div>
                  
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold text-slate-700">Final Payable Amount</span>
                      <span className="text-xl font-bold text-blue-600">₹{searchedLoan.finalPayable}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-slate-800">Verification Status</h2>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-700">EMI Payments Verified</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-700">Penalties Cleared</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-700">Charges Cleared</span>
                    </div>
                ...
                {loanStatus === 'CLOSED' && (
                  <div className="mt-4 p-3 bg-green-50 rounded-lg flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-green-700">Loan has been successfully closed</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-slate-800">NOC Information</h2>
                </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <p className="text-xs text-slate-500 mb-1">Loan Closure Date</p>
                      <p className="font-medium text-slate-800">{closureDate}</p>
                    </div>
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <p className="text-xs text-slate-500 mb-1">Final Payment Amount</p>
                      <p className="font-medium text-slate-800">₹{searchedLoan.finalPayable}</p>
                    </div>
                  </div>
                  
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <p className="text-xs text-blue-600 mb-1">Closure Reference Number</p>
                    <p className="font-medium text-blue-700">{closureReference}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-slate-800">NOC Preview</h2>
                </div>
                
                {/* NOC Certificate Preview */}
                <div className="border-2 border-dashed border-slate-200 rounded-lg p-6 mb-6">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-slate-800">NO OBJECTION CERTIFICATE</h3>
                    <p className="text-xs text-slate-500">Reference: {closureReference}</p>
                  </div>
                  
                  <div className="space-y-3 text-sm">
                    <p className="text-slate-600">
                      This is to certify that the loan availed by <span className="font-semibold">{searchedLoan.customerName}</span> 
                      {' '}(Loan Account: {searchedLoan.accountNumber}) has been fully repaid and settled.
                    </p>
                    
                    <div className="bg-slate-50 p-3 rounded-lg">
                      <div className="flex justify-between text-xs">
                        <span className="text-slate-500">Loan Amount:</span>
                        <span className="font-medium">₹{searchedLoan.loanAmount}</span>
                      </div>
                      ...
                      <div className="flex justify-between text-xs mt-1">
                        ...
                        <span className="font-medium">₹{searchedLoan.finalPayable}</span>
                      </div>
                    </div>
                    
                    <p className="text-slate-600">
                      The lender has no objection to the closure of this loan and confirms that all 
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-200">
                      <div className="flex justify-between">
                        <div>
                          ...
                          <p className="font-medium text-slate-800">For ABC Bank Ltd.</p>
                        </div>
                        <div>
                ...
                {nocGenerated && (
                  <div className="mt-4 p-3 bg-green-50 rounded-lg flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-green-700">NOC generated successfully</span>
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-slate-800">Closed Loans</h2>
          <span className="text-sm text-slate-500">Total: {closedLoans.length + mockClosedLoans.length}</span>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
              ...
              <tbody className="divide-y divide-slate-200">
                ...
                {closedLoans.map((loan, index) => (
                  <tr key={`new-${index}`} className="hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4 text-sm font-medium text-slate-800">{loan.accountNumber}</td>
                    <td className="px-6 py-4 text-sm text-slate-600">{loan.customerName}</td>
                    <td className="px-6 py-4 text-sm text-slate-600">₹{loan.loanAmount}</td>
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">
                        {loan.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-sm text-slate-600">{loan.closureDate}</td>
                  </tr>
                ))}
                
                {/* Mock closed loans */}
                {mockClosedLoans.map((loan, index) => (
          ...
          {(closedLoans.length === 0 && mockClosedLoans.length === 0) && (
