              ...
              <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Button className="!bg-white !text-gray-700 !shadow-none border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-50">
                        ...
                        {[3, 6, 12, 18, 24, 36, 48, 60, 72, 84, 96, 120].map(
                          (month) => (
                            <Button
                              ...
                              className={`!bg-transparent !shadow-none !p-3 rounded-lg border flex flex-col items-center justify-center transition-all ${
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            <Button
                              ...
                              className={`!p-0 !bg-transparent !shadow-none w-12 h-6 rounded-full relative transition-all ${
                                loanConfig[item.field]
                ...
                {activeCategory === "loanTypes" && (
                  <div className="space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full !bg-transparent !text-gray-600 !shadow-none p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-green-400 hover:bg-green-50 flex items-center justify-center gap-2"
                    >
