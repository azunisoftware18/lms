...
import { financialData } from "../../lib/dumyData";
    ...
    <div className={`py-16 px-4 ${colorVariables.LIGHT_BG} font-sans min-h-screen`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center md:text-left mb-12">
          <BarChart3 className={`w-10 h-10 md:mx-0 mx-auto mb-3 ${colorVariables.PRIMARY_COLOR}`} />
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">
            Financial <span className={colorVariables.PRIMARY_COLOR}>Information</span>
          </h1>
          ...
          <div className="flex-grow w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {currentReports.map((report, index) => (
                ...
                >
                  <BarChart3 className={`w-8 h-8 mb-3 ${colorVariables.PRIMARY_COLOR}`} />
