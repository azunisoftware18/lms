			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">
						Committees of the{' '}
						<span className={colorVariables.PRIMARY_COLOR}>Board</span>
					</h1>
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						Governing bodies ensuring robust corporate governance and
                ...
                ${activeIndex === index ? `${colorVariables.LIGHT_BG} text-blue-800` : 'hover:bg-gray-50 text-gray-900'}`}
								...
								<div className="flex items-center">
									<committee.icon
										className={`w-6 h-6 mr-3 ${activeIndex === index ? colorVariables.PRIMARY_COLOR : 'text-gray-500'}`}
									/>
