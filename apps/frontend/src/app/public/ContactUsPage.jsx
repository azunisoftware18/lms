						...
						<div className="space-y-5 text-sm leading-relaxed">
							...
							<div className="border-l-4 border-blue-400 pl-3">
								...
								<p className="flex items-start gap-2 mt-1">
									...
									<MapPin
										size={16}
										className={`mt-1 ${colorVariables.PRIMARY_COLOR}`}
									/>
									702, Seventh Floor, Unique Aspire, Plot No. 13-14 Cosmo
									Colony, Amrapali Marg, Vaishali Nagar, Jaipur,
									Rajasthan–302021
								</p>
							</div>
