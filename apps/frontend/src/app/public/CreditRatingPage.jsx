			...
			<div className="container mx-auto max-w-6xl">
				...
				<div className="text-center mb-12">
					...
					<h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">
						Our Credit{' '}
						<span className={colorVariables.PRIMARY_COLOR}>Ratings</span>
					</h1>
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						Transparency and trust reflected in our consistent ratings from
						leading agencies.
					</p>
				</div>
				...
				<div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100">
					<div className="overflow-x-auto">
						<div className="min-w-full">
							...
							<div
								className={`grid grid-cols-1 md:grid-cols-4 ${colorVariables.PRIMARY_BG} text-white font-bold text-sm md:text-base p-4 uppercase tracking-wider`}>
							...
							{creditRatingData.map((item, index) => (
								<div
									...
									{/* Agency Name (Desktop) */}
									<div className="hidden md:block">{item.agency}</div>

									{/* Instrument Type */}
									<div className="py-1 md:py-0">
										<span className="md:hidden font-semibold mr-1">
											Instrument:
										</span>{' '}
										{item.instrument}
									</div>
				...
				<div className="mt-8 text-center p-4 rounded-lg border border-blue-200 bg-blue-50/70">
					<p className="text-sm text-gray-700 flex items-start justify-center">
						<TrendingUp
							className={`w-5 h-5 mr-2 mt-0.5 ${colorVariables.PRIMARY_COLOR}`}
						/>
						The ratings reflect our strong financial position and robust
