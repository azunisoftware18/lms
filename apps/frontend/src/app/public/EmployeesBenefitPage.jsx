			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">
						Employee{' '}
						<span className={colorVariables.PRIMARY_COLOR}>Benefits</span>
					</h1>
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						We invest in our people. Discover the comprehensive benefits package
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{benefitsData.map((benefit, index) => (
						<div
							...
							<benefit.icon
								className={`w-10 h-10 mb-4 ${colorVariables.PRIMARY_COLOR}`}
							/>
							...
							<Link
								to="#"
								className={`mt-3 inline-block font-semibold text-sm ${colorVariables.PRIMARY_COLOR} hover:text-blue-700`}>
								Learn More
							</Link>
						</div>
					))}
				...
				{/* ===== CTA Section ===== */}
				<div
					className={`mt-16 p-8 rounded-xl text-center shadow-xl ${colorVariables.PRIMARY_BG}`}>
