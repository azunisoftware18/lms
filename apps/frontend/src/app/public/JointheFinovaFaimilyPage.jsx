...
import { jobOpenings } from '../../lib/dumyData';

export default function JointheFinovaFaimilyPage() {
	return (
		<div
			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">
						Join the Finova{' '}
						<span className={colorVariables.PRIMARY_COLOR}>Family</span>
					</h1>
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						Build your career with a leading FinTech company. Explore exciting
						opportunities below.
					</p>
				</div>
				...
				<div className="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100">
					<div className="p-5 bg-blue-50 border-b border-blue-200">
						<h2 className="text-xl font-bold text-gray-900 flex items-center">
							<Zap className={`w-5 h-5 mr-2 ${colorVariables.PRIMARY_COLOR}`} />{' '}
							...
							<a
								...
								<div className="flex justify-between items-center flex-wrap">
									<div className="mb-2 md:mb-0">
										...
										<p
											className={`text-sm font-medium ${colorVariables.PRIMARY_COLOR} flex items-center mt-1`}>
				...
				<div className="text-center mt-12">
					<p className="text-lg text-gray-700">
						...
						<a
							href="#"
							className={`ml-2 font-bold ${colorVariables.PRIMARY_COLOR} hover:text-blue-700 transition`}>
