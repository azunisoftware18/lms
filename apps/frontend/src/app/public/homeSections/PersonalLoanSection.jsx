import { Star, Heart, CheckCircle, IndianRupee, Percent, Calendar, Clock } from 'lucide-react';
...
export default function PersonalLoanSection() {
  const data = loanProductsData.personal;
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              {data.title.split(' ')[0]} <span className={`text-${data.color}-600`}>{data.title.split(' ')[1]}</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Heart className={`w-6 h-6 text-${data.color}-600`} />
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                <div className={`text-center p-3 bg-${data.color}-50 rounded-lg`}>
                  <Clock className={`w-6 h-6 text-${data.color}-600 mx-auto mb-1`} />
                  <span className="text-sm font-medium">{data.details.approval}</span>
                </div>
              </div>
              ...
              <Button
                ...
                variant="primary"
                size="lg"
                className={`w-full mt-6 bg-${data.color}-600 text-white py-3 rounded-lg font-semibold hover:bg-${data.color}-700 transition`}
              >
