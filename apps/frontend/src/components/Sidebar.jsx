      ...
      items: [
        {
          ...
          subItems: [
            { name: "Account Masters", path: "accounting/account-masters" },
            { name: "Transaction Books", path: "accounting/transaction-books" },
            { name: "Profit And Loss Balances", path: "accounting/profit-loss-balances" },
