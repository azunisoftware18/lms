...
export const CRC_ROLES = {
  admin: "admin",
  creditManager: "credit_manager",
  creditAnalyst: "credit_analyst",
};

export const CRC_RISK_FILTER_OPTIONS = [
...
export const CRC_CONSUMER_DUMMY_DATA = [
  {
    id: 1,
    customerName: "Rajesh Kumar",
...
export const CRC_COMMERCIAL_DUMMY_DATA = [
  {
    id: 1,
    businessName: "Tech Innovations Pvt Ltd",
    gstNumber: "27ABCDE1234F1Z5",
    cinNumber: "U72900MH2010PTC123456",
    annualTurnover: 25000000,
    bankSummary: "Healthy",
    directorCreditHistory: "Good",
    activeLoans: 3,
    legalAlerts: 0,
    businessRiskRating: "Low",
    gstVerification: "Valid",
    bankAnalysis: "Strong",
    mcaCheck: "Active",
    directorProfile: "Verified",
    riskCategory: "Low Risk",
    approvedLimit: 10000000,
    loanRecommendation: "Approved",
    complianceWarnings: "None",
    lastChecked: "2024-03-15",
    statusColor: "green",
  },
  {
    ...
    gstNumber: "29FGHIJ5678K2Z9",
    cinNumber: "U51909GJ2015PTC234567",
    annualTurnover: 15000000,
    bankSummary: "Moderate",
    directorCreditHistory: "Average",
    activeLoans: 5,
    legalAlerts: 2,
    businessRiskRating: "Medium",
    gstVerification: "Valid",
    bankAnalysis: "Average",
    mcaCheck: "Active",
    directorProfile: "Verified",
    riskCategory: "Medium Risk",
    approvedLimit: 5000000,
    loanRecommendation: "Review Required",
    complianceWarnings: "2 pending notices",
    lastChecked: "2024-03-14",
    statusColor: "yellow",
  },
  {
    ...
    gstNumber: "07KLMNO9012P3Z1",
    cinNumber: "U45400DL2012PTC345678",
    annualTurnover: 8000000,
    bankSummary: "Poor",
    directorCreditHistory: "Poor",
    activeLoans: 7,
    legalAlerts: 5,
    businessRiskRating: "High",
    gstVerification: "Cancelled",
    bankAnalysis: "Weak",
    mcaCheck: "Struck Off",
    directorProfile: "Flagged",
    riskCategory: "High Risk",
    approvedLimit: 1000000,
    loanRecommendation: "Reject",
